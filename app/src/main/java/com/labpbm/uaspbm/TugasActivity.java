    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profil.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(TugasActivity.this, ProfilActivity.class);
        ...
        kursus.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(TugasActivity.this, KursusActivity.class);
                startActivity(intent);
            }});
        ...
        riwayat.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(TugasActivity.this, RiwayatActivity.class);
                startActivity(intent);
            }});
    }
}